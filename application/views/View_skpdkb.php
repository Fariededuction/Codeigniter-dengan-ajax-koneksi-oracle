        ...
        <div class="card">
            ...
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="table-stpdkb">
                        <thead>
                            <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
        tabel_skpdkb = $('#table-stpdkb').DataTable({
        ...
        $('#btn-filter').click(function() { //button filter event click
            tabel_skpdkb.ajax.reload(); //just reload table
        });
...
{
    tabel_skpdkb.ajax.reload(null,false); //reload datatable ajax 
}
